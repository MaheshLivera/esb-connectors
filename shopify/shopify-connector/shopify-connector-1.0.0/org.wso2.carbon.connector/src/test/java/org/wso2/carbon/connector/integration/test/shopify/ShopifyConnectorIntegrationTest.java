...
public class ShopifyConnectorIntegrationTest extends ConnectorIntegrationTestBase {
   ...
   public void testCreateCustomerWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(esbRestResponse.getBody().getJSONObject("customer").getString("created_at"), apiRestResponse
            .getBody().getJSONObject("customer").getString("created_at"));
   ...
   public void testlistCustomersNegativeCase() throws Exception {
      ...
      Assert.assertEquals(esbRestResponse.getBody().getString("errors"), apiRestResponse.getBody().getString("errors"));
   ...
   public void testGetProductByIdWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
      Assert.assertEquals(esbRestResponse.getBody().getJSONObject("product").getString("id"), apiRestResponse.getBody()
            .getJSONObject("product").getString("id"));
      ...
      Assert.assertEquals(esbRestResponse.getBody().getJSONObject("product").getString("product_type"), apiRestResponse
            .getBody().getJSONObject("product").getString("product_type"));
   ...
   public void testCreateOrderWithMandatoryParameters() throws Exception {
      ...
      Assert.assertEquals(connectorProperties.getProperty("variantId"), apiRestResponse.getBody()
            .getJSONObject("order").getJSONArray("line_items").getJSONObject(0).getString("variant_id"));
      Assert.assertEquals(esbRestResponse.getBody().getJSONObject("order").getString("name"), apiRestResponse.getBody()
            .getJSONObject("order").getString("name"));
   ...
   public void listOrdersWithMandatoryParameters() throws Exception {
      ...
      if (esbResponseArray.length() > 0) {
         ...
         Assert.assertEquals(esbResponseArray.getJSONObject(0).get("id").toString(), apiResponseArray.getJSONObject(0)
               .get("id").toString());
   ...
   public void listOrdersWithOptionalParameters() throws Exception {
      ...
      if (esbResponseArray.length() > 0) {
         ...
         Assert.assertEquals(esbResponseArray.getJSONObject(0).get("email").toString(),
               apiResponseArray.getJSONObject(0).get("email").toString());
   ...
   public void createFulfillmentWithMandatoryParameters() throws Exception {
      ...
      String apiEndPoint =
            connectorProperties.getProperty("apiUrl") + "/admin/orders/" + connectorProperties.getProperty("orderId")
                  + "/fulfillments/" + esbJsonObject.getString("id") + ".json";
   ...
   public void createFulfillmentWithOptionalParameters() throws Exception {
      ...
      String apiEndPoint =
            connectorProperties.getProperty("apiUrl") + "/admin/orders/" + connectorProperties.getProperty("orderId1")
                  + "/fulfillments/" + esbJsonObject.get("id") + ".json";
   ...
   public void testlistFulfillmentsWithOptionalParameters() throws Exception {
      ...
      String apiEndPoint =
            connectorProperties.getProperty("apiUrl") + "/admin/orders/" + connectorProperties.getProperty("orderId")
                  + "/fulfillments.json?fields=status,order_id";
      RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
   ...
   /**
    * Positive test case for updateOrder method with mandatory parameters.
    */
   @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateOrderWithMandatoryParameters" }, description = "Shopify {updateOrder} integration test with mandatory parameters.")
   public void testUpdateOrderWithMandatoryParameters() throws Exception {
   
      esbRequestHeadersMap.put("Action", "urn:updateOrder");
      RestResponse<JSONObject> esbRestResponse =
            sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateOrder_mandatory.json");
      ...
      Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
      Assert.assertEquals(connectorProperties.getProperty("updateOrderTag"),
            apiRestResponse.getBody().getJSONObject("order").getString("tags"));
      Assert.assertEquals(connectorProperties.getProperty("updateOrderNote"),
            apiRestResponse.getBody().getJSONObject("order").getString("note"));
      
   }
   
   /**
    * Method Name: updateOrder Skipped Case: optional case Reason: No optional parameter(s) to assert.
    */
   
   /**
    * Negative test case for updateOrder method.
    */
   @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateOrderWithMandatoryParameters" }, description = "Shopify {listFulfillments} integration test with negative case.")
   public void testUpdateOrderNegativeCase() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/admin/orders/INVALID.json";
      RestResponse<JSONObject> apiRestResponse =
            sendJsonRestRequest(apiEndPoint, "PUT", apiRequestHeadersMap, "api_updateOrder_negative.json");
   ...
   /**
    * Positive test case for updateProduct method with mandatory parameters.
    */
   @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateProductWithMandatoryParameters" }, description = "Shopify {updateProduct} integration test with mandatory parameters.")
   public void testUpdateProductWithMandatoryParameters() throws Exception {
   
      esbRequestHeadersMap.put("Action", "urn:updateProduct");
      RestResponse<JSONObject> esbRestResponse =
            sendJsonRestRequest(proxyUrl, "POST", esbRequestHeadersMap, "esb_updateProduct_mandatory.json");
      ...
      Assert.assertEquals(esbRestResponse.getHttpStatusCode(), 200);
      Assert.assertEquals(connectorProperties.getProperty("updateProductTitle"), apiRestResponse.getBody()
            .getJSONObject("product").getString("title"));
      Assert.assertEquals(connectorProperties.getProperty("updateProductType"), apiRestResponse.getBody()
            .getJSONObject("product").getString("product_type"));
      
   }
   
   /**
    * Method Name: updateProduct Skipped Case: optional case Reason: No optional parameter(s) to assert.
    */
   
   /**
    * Negative test case for updateProduct method.
    */
   @Test(groups = { "wso2.esb" }, dependsOnMethods = { "testCreateProductWithMandatoryParameters" }, description = "Shopify {updateProduct} integration test with negative case.")
   public void testUpdateProductNegativeCase() throws Exception {
      ...
      String apiEndPoint = connectorProperties.getProperty("apiUrl") + "/admin/products/INVALID.json";
      RestResponse<JSONObject> apiRestResponse =
            sendJsonRestRequest(apiEndPoint, "PUT", apiRequestHeadersMap, "api_updateProduct_negative.json");
